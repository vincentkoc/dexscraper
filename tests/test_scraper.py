...
from dexscraper.config import PresetConfigs, Chain, DEX
...
class TestDexScraper:
    ...
    def test_scraper_headers(self):
        ...
        assert headers1['User-Agent'] != headers2['User-Agent'] or headers2['User-Agent'] != headers3['User-Agent']
    ...
    def test_token_profile_building(self):
        ...
        profile = scraper._build_token_profile(
            numeric_clusters, addresses, urls, 
            record_position=0, record_span=100
        )
