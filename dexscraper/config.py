...
class ScrapingConfig:
    ...
    def build_websocket_url(self) -> str:
        ...
        base_url = f"wss://io.dexscreener.com/dex/screener/v5/pairs/{self.timeframe.value}/1"
...
class PresetConfigs:
    ...
    @staticmethod
    def trending(chain: Chain = Chain.SOLANA, timeframe: Timeframe = Timeframe.H24) -> ScrapingConfig:
    ...
    @staticmethod
    def top_volume(chain: Chain = Chain.SOLANA, min_liquidity: int = 25000, min_txns: int = 50) -> ScrapingConfig:
        ...
        return ScrapingConfig(
            ...
            filters=Filters(
                ...
                txns_h24_min=min_txns
            )
        )
    
    @staticmethod
    def gainers(chain: Chain = Chain.SOLANA, min_liquidity: int = 25000, min_volume: int = 10000) -> ScrapingConfig:
    ...
    @staticmethod
    def new_pairs(chain: Chain = Chain.SOLANA, max_age_hours: int = 24) -> ScrapingConfig:
